...
void setup() {
  size(800, 600, P3D); // 解析度改為跟背景一致
  bg = loadImage("123.jpg"); // 載入背景圖片
...
void draw() {
  background(204); // 可以保留這行或移除
  image(bg, 0, 0, width, height); // 畫背景圖片

  translate(400, 500); // 改為畫面中心點
  scale(10, -10, 10); // Y 軸反轉，Z 軸正常
